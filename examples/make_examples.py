...
crime = Story(
    ...
    photo=Photo('assets/stock/crime_scene_police_cordon.jpg', nature='representative',
...
weather = Story(
    ...
    photo=Photo('assets/stock/coastal_storm_sea_warning.jpg', nature='representative',
...
health = Story(
    ...
    photo=Photo('assets/stock/health_hospital_campus_outpatients.jpg', nature='representative',
